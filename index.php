...
<body>
  ...
  <div class="page-content p-5" id="content">
    ...
    <!-- Demo content -->
    <h2 class="display-4 text-center"><b>reCALL</b></h2>
    ...
    <div class="row">
      <div class="col-lg-6">
        ...
        <p style="color: #111; font-weight:400" class="lead">reCALL is a Secured Self Manager helpful for an individual on a daily basis. It will do a variety of essential everyday life tasks concurrently, such as taking & printing notes, organizing tasks, and managing passwords.</p>

      </div>
      <div class="col-lg-6">


        <p style="color: #111; font-weight:400" class="lead">reCALL is a Secured Self Manager, note-taking, and Password Manager for free-form information collection and support delivered as part of the free, web-based application that allows users to Create, Read, Update, and Delete data. It will implement numerous basic functions simultaneously.
        </p>
      </div>
    </div>
